...
namespace parsertl
{
        ...
        rules_type& rules_)
    {
        ...
        //parsertl::debug::dump(grules, std::cout, true); return;
            ...
            results_.entry.action != action::accept)
        {
            if (results_.entry.action == action::reduce)
            {
                if (results_.entry.param == token_index_)
                {
                    ...
                    rules_.token(token_.first, token_.second);
                }
                else if (results_.entry.param == left_index_)
                {
                    ...
                    rules_.left(token_.first, token_.second);
                }
                else if (results_.entry.param == right_index_)
                {
                    ...
                    rules_.right(token_.first, token_.second);
                }
                else if (results_.entry.param == nonassoc_index_)
                {
                    ...
                    rules_.nonassoc(token_.first, token_.second);
                }
                else if (results_.entry.param == precedence_index_)
                {
                    ...
                    rules_.precedence(token_.first, token_.second);
                }
