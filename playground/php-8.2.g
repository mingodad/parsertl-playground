...
"abstract"	T_ABSTRACT
"&"{WHITESPACE}*("$"|"...")	T_AMPERSAND_FOLLOWED_BY_VAR_OR_VARARG
...
"=>"	T_DOUBLE_ARROW
"("{TABS_AND_SPACES}("double"|"float"){TABS_AND_SPACES}")"	T_DOUBLE_CAST
"echo"	T_ECHO
"..."	T_ELLIPSIS
"else"	T_ELSE
"elseif"	T_ELSEIF
...
"static"	T_STATIC
"("{TABS_AND_SPACES}("string"|"binary"){TABS_AND_SPACES}")"	T_STRING_CAST
...
"^="	T_XOR_EQUAL
"yeld"	T_YIELD
"yield"{WHITESPACE}"from"[^a-zA-Z0-9_\x80-\xff]	T_YIELD_FROM
