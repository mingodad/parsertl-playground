...
///////////
/* To reduce parser build time (to 1/3) and memory usage (to 50%) */
//nonreserved_word
%fallback IDENTIFIER TOK_ABORT
%fallback IDENTIFIER TOK_ACCESS
%fallback IDENTIFIER TOK_ACCUMULATED
%fallback IDENTIFIER TOK_ACTIVATE
%fallback IDENTIFIER TOK_ACTIVE
%fallback IDENTIFIER TOK_ALIGNED
%fallback IDENTIFIER TOK_ALLOW
%fallback IDENTIFIER TOK_ALLOWED
%fallback IDENTIFIER TOK_APPEND
%fallback IDENTIFIER TOK_AREA
%fallback IDENTIFIER TOK_AUTOABORT
%fallback IDENTIFIER TOK_AUTOMATIC
%fallback IDENTIFIER TOK_REPEATABLE
%fallback IDENTIFIER TOK_SERIALIZABLE
%fallback IDENTIFIER TOK_ALL_DDL
%fallback IDENTIFIER TOK_ALL_DML
%fallback IDENTIFIER TOK_ALL_UTILITY
%fallback IDENTIFIER TOK_ALTER_LIBRARY
%fallback IDENTIFIER TOK_ALTER_MV
%fallback IDENTIFIER TOK_ALTER_MV_GROUP
%fallback IDENTIFIER TOK_ALTER_ROUTINE
%fallback IDENTIFIER TOK_ALTER_ROUTINE_ACTION
%fallback IDENTIFIER TOK_ALTER_SYNONYM
%fallback IDENTIFIER TOK_ALTER_TABLE
%fallback IDENTIFIER TOK_ALTER_TRIGGER
%fallback IDENTIFIER TOK_ALTER_VIEW
%fallback IDENTIFIER TOK_ALWAYS
%fallback IDENTIFIER TOK_AQR
%fallback IDENTIFIER TOK_ARKCMP
%fallback IDENTIFIER TOK_ASCENDING
%fallback IDENTIFIER TOK_ATOMIC
%fallback IDENTIFIER TOK_ATTRIBUTE
%fallback IDENTIFIER TOK_ATTRIBUTES
%fallback IDENTIFIER TOK_AUDITONREFRESH
%fallback IDENTIFIER TOK_AUDIT
%fallback IDENTIFIER TOK_AUTOBEGIN
%fallback IDENTIFIER TOK_AUTOCOMMIT
%fallback IDENTIFIER TOK_AUDITCOMPRESS
%fallback IDENTIFIER TOK_AUTHENTICATION
%fallback IDENTIFIER TOK_AVERAGE_STREAM_WAIT
%fallback IDENTIFIER TOK_BACKUP
%fallback IDENTIFIER TOK_BLOCKSIZE
%fallback IDENTIFIER TOK_BT
%fallback IDENTIFIER TOK_BRIEF
%fallback IDENTIFIER TOK_BUFFER
%fallback IDENTIFIER TOK_BUFFERED
%fallback IDENTIFIER TOK_BYTES
%fallback IDENTIFIER TOK_C
%fallback IDENTIFIER TOK_CANCEL
%fallback IDENTIFIER TOK_CARDINALITY
%fallback IDENTIFIER TOK_CATALOGS
%fallback IDENTIFIER TOK_CATALOG_NAME
%fallback IDENTIFIER TOK_CATCHUP
%fallback IDENTIFIER TOK_CENTURY
%fallback IDENTIFIER TOK_CHANGED
%fallback IDENTIFIER TOK_CHANGES
%fallback IDENTIFIER TOK_CHARS
%fallback IDENTIFIER TOK_CHARACTERS
%fallback IDENTIFIER TOK_CHARACTER_SET_CATALOG
%fallback IDENTIFIER TOK_CHARACTER_SET_NAME
%fallback IDENTIFIER TOK_CHARACTER_SET_SCHEMA
%fallback IDENTIFIER TOK_CLASS_ORIGIN
%fallback IDENTIFIER TOK_CLEAN
%fallback IDENTIFIER TOK_CLEANUP
%fallback IDENTIFIER TOK_CLEAR
%fallback IDENTIFIER TOK_CLEARONPURGE
%fallback IDENTIFIER TOK_CLUSTER
%fallback IDENTIFIER TOK_CLUSTERING
%fallback IDENTIFIER TOK_COLLATION_CATALOG
%fallback IDENTIFIER TOK_COLLATION_NAME
%fallback IDENTIFIER TOK_COLLATION_SCHEMA
%fallback IDENTIFIER TOK_COLUMNS
%fallback IDENTIFIER TOK_COLUMN_NAME
%fallback IDENTIFIER TOK_COLUMN_NUMBER
%fallback IDENTIFIER TOK_COMMANDS
%fallback IDENTIFIER TOK_COMMAND_FUNCTION
%fallback IDENTIFIER TOK_COMMENT
%fallback IDENTIFIER TOK_COMMITTED
%fallback IDENTIFIER TOK_COMP
%fallback IDENTIFIER TOK_COMPACT
%fallback IDENTIFIER TOK_COMPARE
%fallback IDENTIFIER TOK_COMPLETE
%fallback IDENTIFIER TOK_COMPONENT
%fallback IDENTIFIER TOK_COMPONENTS
%fallback IDENTIFIER TOK_COMPRESS
%fallback IDENTIFIER TOK_COMPRESSED
%fallback IDENTIFIER TOK_COMPRESSION
%fallback IDENTIFIER TOK_CONCURRENT
%fallback IDENTIFIER TOK_CONCURRENCY
%fallback IDENTIFIER TOK_CONDITION_NUMBER
%fallback IDENTIFIER TOK_CONFIG
%fallback IDENTIFIER TOK_CONNECTION_NAME
%fallback IDENTIFIER TOK_CONSTRAINT_CATALOG
%fallback IDENTIFIER TOK_CONSTRAINT_NAME
%fallback IDENTIFIER TOK_CONSTRAINT_SCHEMA
%fallback IDENTIFIER TOK_CONTAINS
%fallback IDENTIFIER TOK_CONTROL
%fallback IDENTIFIER TOK_COPY
%fallback IDENTIFIER TOK_COST
%fallback IDENTIFIER TOK_CPP
%fallback IDENTIFIER TOK_CPU
%fallback IDENTIFIER TOK_CREATE_LIBRARY
%fallback IDENTIFIER TOK_CREATE_MV
%fallback IDENTIFIER TOK_CREATE_MV_GROUP
%fallback IDENTIFIER TOK_CREATE_PROCEDURE
%fallback IDENTIFIER TOK_CREATE_ROUTINE
%fallback IDENTIFIER TOK_CREATE_ROUTINE_ACTION
%fallback IDENTIFIER TOK_CREATE_TABLE
%fallback IDENTIFIER TOK_CREATE_TRIGGER
%fallback IDENTIFIER TOK_CREATE_SYNONYM
%fallback IDENTIFIER TOK_CREATE_VIEW
%fallback IDENTIFIER TOK_CQD
%fallback IDENTIFIER TOK_CURSOR_NAME
%fallback IDENTIFIER TOK_CACHE
%fallback IDENTIFIER TOK_CYCLE
%fallback IDENTIFIER TOK_D
%fallback IDENTIFIER TOK_DATA
%fallback IDENTIFIER TOK_DATETIME_CODE
%fallback IDENTIFIER TOK_DBA
%fallback IDENTIFIER TOK_DCOMPRESS
%fallback IDENTIFIER TOK_DDL
%fallback IDENTIFIER TOK_DE
%fallback IDENTIFIER TOK_DECADE
%fallback IDENTIFIER TOK_DEFINER
%fallback IDENTIFIER TOK_DEFINITION
%fallback IDENTIFIER TOK_DEFAULTS
%fallback IDENTIFIER TOK_DELAY
%fallback IDENTIFIER TOK_DELIMITER
%fallback IDENTIFIER TOK_DEPENDENT
%fallback IDENTIFIER TOK_DESCENDING
%fallback IDENTIFIER TOK_DETAIL
%fallback IDENTIFIER TOK_DETAILS
%fallback IDENTIFIER TOK_DIRECTEDBY
%fallback IDENTIFIER TOK_DISABLE
%fallback IDENTIFIER TOK_DISK
%fallback IDENTIFIER TOK_DISPLAY
%fallback IDENTIFIER TOK_DIVISION
%fallback IDENTIFIER TOK_DO
%fallback IDENTIFIER TOK_DOUBLE_IEEE
%fallback IDENTIFIER TOK_DOW
%fallback IDENTIFIER TOK_DOY
%fallback IDENTIFIER TOK_DROP_LIBRARY
%fallback IDENTIFIER TOK_DROP_MV
%fallback IDENTIFIER TOK_DROP_MV_GROUP
%fallback IDENTIFIER TOK_DROP_PROCEDURE
%fallback IDENTIFIER TOK_DROP_ROUTINE
%fallback IDENTIFIER TOK_DROP_ROUTINE_ACTION
%fallback IDENTIFIER TOK_DROP_SYNONYM
%fallback IDENTIFIER TOK_DROP_TABLE
%fallback IDENTIFIER TOK_DROP_TRIGGER
%fallback IDENTIFIER TOK_DROP_VIEW
%fallback IDENTIFIER TOK_DROPPABLE
%fallback IDENTIFIER TOK_DSLACK
%fallback IDENTIFIER TOK_DUPLICATE
%fallback IDENTIFIER TOK_DYNAMIC_FUNCTION
%fallback IDENTIFIER TOK_EID
%fallback IDENTIFIER TOK_ENABLE
%fallback IDENTIFIER TOK_ENFORCED
%fallback IDENTIFIER TOK_ENFORCERS
%fallback IDENTIFIER TOK_ERROR
%fallback IDENTIFIER TOK_ENTERPRISE
%fallback IDENTIFIER TOK_ENTRY
%fallback IDENTIFIER TOK_ENTRIES
%fallback IDENTIFIER TOK_EPOCH
%fallback IDENTIFIER TOK_ET
%fallback IDENTIFIER TOK_EUROPEAN
%fallback IDENTIFIER TOK_EXCEPTIONS
%fallback IDENTIFIER TOK_EXCEPTION_TABLE
%fallback IDENTIFIER TOK_EXCHANGE
%fallback IDENTIFIER TOK_EXCHANGE_AND_SORT
%fallback IDENTIFIER TOK_EXCLUSIVE
%fallback IDENTIFIER TOK_EXECUTION
%fallback IDENTIFIER TOK_EXIT
%fallback IDENTIFIER TOK_EXPLAIN
%fallback IDENTIFIER TOK_EXTENT
%fallback IDENTIFIER TOK_EXTRACT_SOURCE
%fallback IDENTIFIER TOK_EXTRACT_TARGET
%fallback IDENTIFIER TOK_FAMILY
%fallback IDENTIFIER TOK_FAST
%fallback IDENTIFIER TOK_FEATURE_VERSION_INFO
%fallback IDENTIFIER TOK_FILE
%fallback IDENTIFIER TOK_FINAL
%fallback IDENTIFIER TOK_FIRST_FSCODE
%fallback IDENTIFIER TOK_FLOAT_IEEE
%fallback IDENTIFIER TOK_FOLLOWING
%fallback IDENTIFIER TOK_FOR_MAXRUNTIME
%fallback IDENTIFIER TOK_FORMAT
%fallback IDENTIFIER TOK_FORCE
%fallback IDENTIFIER TOK_G
%fallback IDENTIFIER TOK_GENERATE
%fallback IDENTIFIER TOK_GENERATED
%fallback IDENTIFIER TOK_GHOST
%fallback IDENTIFIER TOK_GIVE
%fallback IDENTIFIER TOK_GRANTEES
%fallback IDENTIFIER TOK_GRANTED
%fallback IDENTIFIER TOK_HARDWARE
%fallback IDENTIFIER TOK_HASH
%fallback IDENTIFIER TOK_HASH2
%fallback IDENTIFIER TOK_TRAFODION
%fallback IDENTIFIER TOK_HBASE
%fallback IDENTIFIER TOK_HBASE_OPTIONS
%fallback IDENTIFIER TOK_SERIALIZED
%fallback IDENTIFIER TOK_HEADER
%fallback IDENTIFIER TOK_HEADING
%fallback IDENTIFIER TOK_HEADINGS
%fallback IDENTIFIER TOK_HEXADECIMAL
%fallback IDENTIFIER TOK_HORIZONTAL
%fallback IDENTIFIER TOK_HIGH_VALUE
%fallback IDENTIFIER TOK_HOURS
%fallback IDENTIFIER TOK_SHOW
%fallback IDENTIFIER TOK_SHOWSTATS
%fallback IDENTIFIER TOK_SHOWTRANSACTION
%fallback IDENTIFIER TOK_ICOMPRESS
%fallback IDENTIFIER TOK_IGNORETRIGGERS
%fallback IDENTIFIER TOK_IGNORE_TRIGGER
%fallback IDENTIFIER TOK_IMMUTABLE
%fallback IDENTIFIER TOK_IMPLICIT
%fallback IDENTIFIER TOK_INCREMENT
%fallback IDENTIFIER TOK_INDEX_TABLE
%fallback IDENTIFIER TOK_INDICATOR_DATA
%fallback IDENTIFIER TOK_INDICATOR_POINTER
%fallback IDENTIFIER TOK_INDICATOR_TYPE
%fallback IDENTIFIER TOK_INGEST
%fallback IDENTIFIER TOK_INITIALIZATION
%fallback IDENTIFIER TOK_INITIALIZE
%fallback IDENTIFIER TOK_INITIALIZED
%fallback IDENTIFIER TOK_INPUTS
%fallback IDENTIFIER TOK_INSERT_ONLY
%fallback IDENTIFIER TOK_INSERTLOG
%fallback IDENTIFIER TOK_INTERNAL
%fallback IDENTIFIER TOK_INTERNALSP
%fallback IDENTIFIER TOK_INDEX
%fallback IDENTIFIER TOK_INDEXES
%fallback IDENTIFIER TOK_INS
%fallback IDENTIFIER TOK_INTERVALS
%fallback IDENTIFIER TOK_INVOKER
%fallback IDENTIFIER TOK_IO
%fallback IDENTIFIER TOK_ISLACK
%fallback IDENTIFIER TOK_ISOLATE
%fallback IDENTIFIER TOK_INVALID
%fallback IDENTIFIER TOK_INVALIDATE
%fallback IDENTIFIER TOK_JAVA
%fallback IDENTIFIER TOK_K
%fallback IDENTIFIER TOK_LABEL
%fallback IDENTIFIER TOK_LABEL_CREATE
%fallback IDENTIFIER TOK_LABEL_DROP
%fallback IDENTIFIER TOK_LABEL_ALTER
%fallback IDENTIFIER TOK_LABEL_PURGEDATA
%fallback IDENTIFIER TOK_LANGUAGE
%fallback IDENTIFIER TOK_LAST_FSCODE
%fallback IDENTIFIER TOK_LAST_SYSKEY
%fallback IDENTIFIER TOK_LASTSYSKEY
%fallback IDENTIFIER TOK_LEADING_PRECISION
%fallback IDENTIFIER TOK_LEVELS
%fallback IDENTIFIER TOK_EOF
%fallback IDENTIFIER TOK_LIBRARY
%fallback IDENTIFIER TOK_LIBRARIES
%fallback IDENTIFIER TOK_LINE_NUMBER
%fallback IDENTIFIER TOK_LOAD
%fallback IDENTIFIER TOK_LOAD_ID
%fallback IDENTIFIER TOK_LOCATION
%fallback IDENTIFIER TOK_LOCK
%fallback IDENTIFIER TOK_LOCK_ROW
%fallback IDENTIFIER TOK_LOCKING
%fallback IDENTIFIER TOK_LOCKONREFRESH
%fallback IDENTIFIER TOK_LOGGABLE
%fallback IDENTIFIER TOK_LOGON
%fallback IDENTIFIER TOK_LZO
%fallback IDENTIFIER TOK_GZIP
%fallback IDENTIFIER TOK_IUDLOG
%fallback IDENTIFIER TOK_IUD_LOG_TABLE
%fallback IDENTIFIER TOK_RANGE_LOG_TABLE
%fallback IDENTIFIER TOK_LOW_VALUE
%fallback IDENTIFIER TOK_M
%fallback IDENTIFIER TOK_MAP
%fallback IDENTIFIER TOK_MASTER
%fallback IDENTIFIER TOK_MATERIALIZED
%fallback IDENTIFIER TOK_MAXEXTENTS
%fallback IDENTIFIER TOK_MAXRUNTIME
%fallback IDENTIFIER TOK_MAXVALUE
%fallback IDENTIFIER TOK_MEMORY
%fallback IDENTIFIER TOK_MERGE
%fallback IDENTIFIER TOK_MESSAGE
%fallback IDENTIFIER TOK_MESSAGE_LEN
%fallback IDENTIFIER TOK_MESSAGE_OCTET_LEN
%fallback IDENTIFIER TOK_MESSAGE_TEXT
%fallback IDENTIFIER TOK_METADATA
%fallback IDENTIFIER TOK_MINIMAL
%fallback IDENTIFIER TOK_MINUTES
%fallback IDENTIFIER TOK_MINVALUE
%fallback IDENTIFIER TOK_MODE
%fallback IDENTIFIER TOK_MODULES
%fallback IDENTIFIER TOK_MORE
%fallback IDENTIFIER TOK_MOVE
%fallback IDENTIFIER TOK_MOVEMENT
%fallback IDENTIFIER TOK_MTS
%fallback IDENTIFIER TOK_MV
%fallback IDENTIFIER TOK_MULTI
%fallback IDENTIFIER TOK_MULTIDELTA
%fallback IDENTIFIER TOK_MSCK
%fallback IDENTIFIER TOK_MVATTRIBUTE
%fallback IDENTIFIER TOK_MVATTRIBUTES
%fallback IDENTIFIER TOK_MV_TABLE
%fallback IDENTIFIER TOK_MVSTATUS
%fallback IDENTIFIER TOK_MVS_UMD
%fallback IDENTIFIER TOK_REGEXP
%fallback IDENTIFIER TOK_REMOVE
%fallback IDENTIFIER TOK_OPENBLOWNAWAY
%fallback IDENTIFIER TOK_REDEFTIME
%fallback IDENTIFIER TOK_MVGROUP
%fallback IDENTIFIER TOK_MVGROUPS
%fallback IDENTIFIER TOK_MVLOG
%fallback IDENTIFIER TOK_MVUID
%fallback IDENTIFIER TOK_NAME
%fallback IDENTIFIER TOK_NAMED
%fallback IDENTIFIER TOK_NAMESPACE
%fallback IDENTIFIER TOK_NAMETYPE
%fallback IDENTIFIER TOK_NATABLE_CACHE_ENTRIES
%fallback IDENTIFIER TOK_NATIVE
%fallback IDENTIFIER TOK_NECESSARY
%fallback IDENTIFIER TOK_NEEDED
%fallback IDENTIFIER TOK_NEXT
%fallback IDENTIFIER TOK_NODELETE
%fallback IDENTIFIER TOK_NODES
%fallback IDENTIFIER TOK_NOMVLOG
%fallback IDENTIFIER TOK_NOLOG
%fallback IDENTIFIER TOK_NORMAL
%fallback IDENTIFIER TOK_NSK_CODE
%fallback IDENTIFIER TOK_NULLABLE
%fallback IDENTIFIER TOK_NULL_STRING
%fallback IDENTIFIER TOK_NUMBER
%fallback IDENTIFIER TOK_OBSOLETE
%fallback IDENTIFIER TOK_OBJECT
%fallback IDENTIFIER TOK_OBJECTS
%fallback IDENTIFIER TOK_OFFLINE
%fallback IDENTIFIER TOK_OJ
%fallback IDENTIFIER TOK_ONLINE
%fallback IDENTIFIER TOK_OPCODE
%fallback IDENTIFIER TOK_OPTIONS
%fallback IDENTIFIER TOK_ORDERED
%fallback IDENTIFIER TOK_OVER
%fallback IDENTIFIER TOK_OVERRIDE
%fallback IDENTIFIER TOK_PACKED
%fallback IDENTIFIER TOK_PAGE
%fallback IDENTIFIER TOK_PAGES
%fallback IDENTIFIER TOK_PARALLEL
%fallback IDENTIFIER TOK_PARALLELISM
%fallback IDENTIFIER TOK_PARENT
%fallback IDENTIFIER TOK_PARSERFLAGS
%fallback IDENTIFIER TOK_ENVVAR
%fallback IDENTIFIER TOK_ENVVARS
%fallback IDENTIFIER TOK_PARTITION
%fallback IDENTIFIER TOK_PARTITIONING
%fallback IDENTIFIER TOK_PARTITIONS
%fallback IDENTIFIER TOK_PASS
%fallback IDENTIFIER TOK_PATH
%fallback IDENTIFIER TOK_PERTABLE
%fallback IDENTIFIER TOK_PHASE
%fallback IDENTIFIER TOK_PID
%fallback IDENTIFIER TOK_PIPELINE
%fallback IDENTIFIER TOK_PLACING
%fallback IDENTIFIER TOK_POOL
%fallback IDENTIFIER TOK_POPULATE
%fallback IDENTIFIER TOK_POS
%fallback IDENTIFIER TOK_PRECEDING
%fallback IDENTIFIER TOK_PREFER_FOR_SCAN_KEY
%fallback IDENTIFIER TOK_PRESERVE
%fallback IDENTIFIER TOK_PRIORITY
%fallback IDENTIFIER TOK_PRIORITY_DELTA
%fallback IDENTIFIER TOK_PRIVATE
%fallback IDENTIFIER TOK_PRIVILEGE
%fallback IDENTIFIER TOK_PROCESS
%fallback IDENTIFIER TOK_PROGRESS
%fallback IDENTIFIER TOK_PROMPT
%fallback IDENTIFIER TOK_QID
%fallback IDENTIFIER TOK_QID_INTERNAL
%fallback IDENTIFIER TOK_QUERY
%fallback IDENTIFIER TOK_QUERY_CACHE
%fallback IDENTIFIER TOK_HYBRID_QUERY_CACHE
%fallback IDENTIFIER TOK_HYBRID_QUERY_CACHE_ENTRIES
%fallback IDENTIFIER TOK_QUERY_CACHE_ENTRIES
%fallback IDENTIFIER TOK_CATMAN_CACHE
%fallback IDENTIFIER TOK_NATABLE_CACHE
%fallback IDENTIFIER TOK_NAROUTINE_CACHE
%fallback IDENTIFIER TOK_NAROUTINE_ACTION_CACHE
%fallback IDENTIFIER TOK_RANGE
%fallback IDENTIFIER TOK_RANGE_N
%fallback IDENTIFIER TOK_RANGELOG
%fallback IDENTIFIER TOK_RATE
%fallback IDENTIFIER TOK_REAL_IEEE
%fallback IDENTIFIER TOK_REBUILD
%fallback IDENTIFIER TOK_RECOMPUTE
%fallback IDENTIFIER TOK_RECORD_SEPARATOR
%fallback IDENTIFIER TOK_RECOVER
%fallback IDENTIFIER TOK_RECOVERY
%fallback IDENTIFIER TOK_REFRESH
%fallback IDENTIFIER TOK_REGION
%fallback IDENTIFIER TOK_REGISTER
%fallback IDENTIFIER TOK_REGISTERED
%fallback IDENTIFIER TOK_REINITIALIZE
%fallback IDENTIFIER TOK_RELATED
%fallback IDENTIFIER TOK_RELATEDNESS
%fallback IDENTIFIER TOK_RELOAD
%fallback IDENTIFIER TOK_REMOTE
%fallback IDENTIFIER TOK_RENAME
%fallback IDENTIFIER TOK_REPAIR
%fallback IDENTIFIER TOK_REPOSITORY
%fallback IDENTIFIER TOK_REQUEST
%fallback IDENTIFIER TOK_REQUIRED
%fallback IDENTIFIER TOK_RESET
%fallback IDENTIFIER TOK_RETURNED_LENGTH
%fallback IDENTIFIER TOK_RETURNED_OCTET_LENGTH
%fallback IDENTIFIER TOK_RETURNED_SQLSTATE
%fallback IDENTIFIER TOK_REWRITE
%fallback IDENTIFIER TOK_ROLE
%fallback IDENTIFIER TOK_ROLES
%fallback IDENTIFIER TOK_ROW_COUNT
%fallback IDENTIFIER TOK_ROWS_INSERTED
%fallback IDENTIFIER TOK_ROWS_DELETED
%fallback IDENTIFIER TOK_ROWS_UPDATED
%fallback IDENTIFIER TOK_ROWS_COVERED
%fallback IDENTIFIER TOK_NUM_OF_RANGES
%fallback IDENTIFIER TOK_ROWWISE
%fallback IDENTIFIER TOK_ROWSET_IND_LAYOUT_SIZE
%fallback IDENTIFIER TOK_ROWSET_SIZE
%fallback IDENTIFIER TOK_ROWSET_VAR_LAYOUT_SIZE
%fallback IDENTIFIER TOK_RUN
%fallback IDENTIFIER TOK_SAFE
%fallback IDENTIFIER TOK_SALT
%fallback IDENTIFIER TOK_SAS_FORMAT
%fallback IDENTIFIER TOK_SAS_LOCALE
%fallback IDENTIFIER TOK_SAS_MODEL_INPUT_TABLE
%fallback IDENTIFIER TOK_SCALAR
%fallback IDENTIFIER TOK_SCALE
%fallback IDENTIFIER TOK_SCAN
%fallback IDENTIFIER TOK_SCHEMAS
%fallback IDENTIFIER TOK_SCHEMA_NAME
%fallback IDENTIFIER TOK_SECONDS
%fallback IDENTIFIER TOK_SECURITY
%fallback IDENTIFIER TOK_SELECTIVITY
%fallback IDENTIFIER TOK_SEPARATE
%fallback IDENTIFIER TOK_SERVER_NAME
%fallback IDENTIFIER TOK_SESSIONS
%fallback IDENTIFIER TOK_SG_TABLE
%fallback IDENTIFIER TOK_SHAPE
%fallback IDENTIFIER TOK_SHARE
%fallback IDENTIFIER TOK_SHARED
%fallback IDENTIFIER TOK_SIGNED
%fallback IDENTIFIER TOK_SINGLEDELTA
%fallback IDENTIFIER TOK_SLACK
%fallback IDENTIFIER TOK_SOFTWARE
%fallback IDENTIFIER TOK_SOURCE
%fallback IDENTIFIER TOK_SNAPSHOT
%fallback IDENTIFIER TOK_SUFFIX
%fallback IDENTIFIER TOK_TARGET
%fallback IDENTIFIER TOK_SOURCE_FILE
%fallback IDENTIFIER TOK_SP_RESULT_SET
%fallback IDENTIFIER TOK_SQL_WARNING
%fallback IDENTIFIER TOK_SQLROW
%fallback IDENTIFIER TOK_START
%fallback IDENTIFIER TOK_STATE
%fallback IDENTIFIER TOK_STATEMENT
%fallback IDENTIFIER TOK_STATIC
%fallback IDENTIFIER TOK_STATISTICS
%fallback IDENTIFIER TOK_STATS
%fallback IDENTIFIER TOK_STATUS
%fallback IDENTIFIER TOK_STORAGE
%fallback IDENTIFIER TOK_STORE
%fallback IDENTIFIER TOK_STORED
%fallback IDENTIFIER TOK_STRING_SEARCH
%fallback IDENTIFIER TOK_STYLE
%fallback IDENTIFIER TOK_SUBCLASS_ORIGIN
%fallback IDENTIFIER TOK_SUBSYSTEM_ID
%fallback IDENTIFIER TOK_HBMAP_TABLE
%fallback IDENTIFIER TOK_SUSPEND
%fallback IDENTIFIER TOK_SYNONYMS
%fallback IDENTIFIER TOK_T
%fallback IDENTIFIER TOK_TABLE_MAPPING
%fallback IDENTIFIER TOK_TABLE_NAME
%fallback IDENTIFIER TOK_TABLES
%fallback IDENTIFIER TOK_TABLESPACE
%fallback IDENTIFIER TOK_TAG
%fallback IDENTIFIER TOK_TEMP_TABLE
%fallback IDENTIFIER TOK_TEXT
%fallback IDENTIFIER TOK_THROUGH
%fallback IDENTIFIER TOK_TIMEOUT
%fallback IDENTIFIER TOK_TITLE
%fallback IDENTIFIER TOK_TRANSFORM
%fallback IDENTIFIER TOK_TRIGGERS
%fallback IDENTIFIER TOK_TRIGGER_CATALOG
%fallback IDENTIFIER TOK_TRIGGER_NAME
%fallback IDENTIFIER TOK_TRIGGER_SCHEMA
%fallback IDENTIFIER TOK_TS
%fallback IDENTIFIER TOK_TYPE
%fallback IDENTIFIER TOK_TYPES
%fallback IDENTIFIER TOK_TYPE_ANSI
%fallback IDENTIFIER TOK_TYPE_FS
%fallback IDENTIFIER TOK_UDF
%fallback IDENTIFIER TOK_UNBOUNDED
%fallback IDENTIFIER TOK_UNCOMMITTED
%fallback IDENTIFIER TOK_UNIVERSAL
%fallback IDENTIFIER TOK_UNLOCK
%fallback IDENTIFIER TOK_UNLOAD
%fallback IDENTIFIER TOK_UNNAMED
%fallback IDENTIFIER TOK_UNREGISTER
%fallback IDENTIFIER TOK_UNSIGNED
%fallback IDENTIFIER TOK_UPD
%fallback IDENTIFIER TOK_UPGRADE
%fallback IDENTIFIER TOK_UPDATE_STATS
%fallback IDENTIFIER TOK_UPDATE_LOB
%fallback IDENTIFIER TOK_UPPERCASE
%fallback IDENTIFIER TOK_USA
%fallback IDENTIFIER TOK_USE
%fallback IDENTIFIER TOK_USERS
%fallback IDENTIFIER TOK_VALUE
%fallback IDENTIFIER TOK_VARIABLE_DATA
%fallback IDENTIFIER TOK_VARIABLE_POINTER
%fallback IDENTIFIER TOK_VOLATILE
%fallback IDENTIFIER TOK_VERSION
%fallback IDENTIFIER TOK_VERSIONS
%fallback IDENTIFIER TOK_VPROC
%fallback IDENTIFIER TOK_VERSION_INFO
%fallback IDENTIFIER TOK_VIEWS
%fallback IDENTIFIER TOK_VSBB
%fallback IDENTIFIER TOK_WAITED
%fallback IDENTIFIER TOK_WAITEDIO
%fallback IDENTIFIER TOK_WOM
%fallback IDENTIFIER TOK_INVOKE
%fallback IDENTIFIER TOK_SHOWCONTROL
%fallback IDENTIFIER TOK_SHOWDDL
%fallback IDENTIFIER TOK_SHOWPLAN
%fallback IDENTIFIER TOK_SHOWSHAPE
%fallback IDENTIFIER TOK_SHOWSET
%fallback IDENTIFIER TOK_SAMPLE
%fallback IDENTIFIER TOK_PERIODIC
%fallback IDENTIFIER TOK_PERCENT
%fallback IDENTIFIER TOK_BALANCE
%fallback IDENTIFIER TOK_EVERY
%fallback IDENTIFIER TOK_EXISTING
%fallback IDENTIFIER TOK_SORT
%fallback IDENTIFIER TOK_CLUSTERS
%fallback IDENTIFIER TOK_BLOCKS
%fallback IDENTIFIER TOK_INCLUSIVE
%fallback IDENTIFIER TOK_SEQUENCE
%fallback IDENTIFIER TOK_SEQUENCES
%fallback IDENTIFIER TOK_SINCE
%fallback IDENTIFIER TOK_MANAGEMENT
%fallback IDENTIFIER TOK_MANUAL
%fallback IDENTIFIER TOK_MIXED
%fallback IDENTIFIER TOK_MVS
%fallback IDENTIFIER TOK_PURGEDATA
%fallback IDENTIFIER TOK_INCREMENTAL
%fallback IDENTIFIER TOK_PROCEDURES
%fallback IDENTIFIER TOK_SUMMARY
%fallback IDENTIFIER TOK_SYSTEM
%fallback IDENTIFIER TOK_UNAVAILABLE
%fallback IDENTIFIER TOK_UID
%fallback IDENTIFIER TOK_STREAM
%fallback IDENTIFIER TOK_SKIP
%fallback IDENTIFIER TOK_CONFLICT
%fallback IDENTIFIER TOK_HOLD
%fallback IDENTIFIER TOK_VALIDATE
%fallback IDENTIFIER TOK_RMS
///////////
