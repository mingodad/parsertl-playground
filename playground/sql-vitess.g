...
non_reserved_keyword :
	...
	| ACTION
	| ACTIVE
	| ADDDATE %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ADMIN
	| AFTER
	| ALGORITHM /*6L*/
	| ALWAYS
	| ANY_VALUE %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ARRAY
	| ASCII
	| AUTO_INCREMENT
	| AUTOEXTEND_SIZE
	| AVG %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| AVG_ROW_LENGTH
	| BEFORE
	| BEGIN
	| BIGINT
	| BIT
	| BIT_AND %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| BIT_OR %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| BIT_XOR %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| BLOB
	| BOOL
	| BOOLEAN
	| BUCKETS
	...
	| CASCADED
	| CHANNEL
	| CHAR %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| CHARSET /*13N*/
	| CHECKSUM
	| CLEANUP
	| CLONE
	...
	| CONSISTENT
	| COPY /*6L*/
	| COUNT %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| CSV
	| CURRENT
	| DATA
	| DATE %prec STRING_TYPE_PREFIX_NON_KEYWORD /*3N*/
	| DATE_ADD %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| DATE_SUB %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| DATETIME
	| DEALLOCATE
	| DECIMAL_TYPE
	| DELAY_KEY_WRITE
	...
	| EXPORT
	| EXTENDED
	| ExtractValue %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| FLOAT_TYPE
	| FIELDS
	| FIRST
	| FIXED
	...
	| FOLLOWING
	| FORMAT
	| FORMAT_BYTES %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| FORMAT_PICO_TIME %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| FULL
	| FUNCTION
	| GENERAL
	| GEOMCOLLECTION
	| GEOMETRY
	| GEOMETRYCOLLECTION
	| GET_LOCK %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| GET_MASTER_PUBLIC_KEY
	| GLOBAL
	| GROUP_CONCAT %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| GTID_EXECUTED
	| GTID_SUBSET %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| GTID_SUBTRACT %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| HASH
	| HEADER
	| HISTOGRAM
	| HISTORY
	...
	| INVOKER
	| INDEXES
	| IS_FREE_LOCK %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| IS_USED_LOCK %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ISOLATION
	| JSON
	| JSON_ARRAY %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_ARRAY_APPEND %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_ARRAY_INSERT %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_CONTAINS %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_CONTAINS_PATH %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_DEPTH %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_EXTRACT %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_INSERT %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_KEYS %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_MERGE %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_MERGE_PATCH %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_MERGE_PRESERVE %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_OBJECT %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_OVERLAPS %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_PRETTY %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_QUOTE %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_REMOVE %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_REPLACE %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_SCHEMA_VALID %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_SCHEMA_VALIDATION_REPORT %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_SEARCH %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_SET %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_STORAGE_FREE %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_STORAGE_SIZE %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_TYPE %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_VALID %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_VALUE %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| JSON_UNQUOTE %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| KEY_BLOCK_SIZE
	| KEYS
	| KEYSPACES
	| LANGUAGE
	...
	| LEVEL
	| LINES
	| LINESTRING %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| LIST
	| LOAD
	| LOCAL
	| LOCATE %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| LOCKED
	| LOGS
	| LONGBLOB
	| LONGTEXT
	| LTRIM %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| MANIFEST
	| MASTER_COMPRESSION_ALGORITHMS
	| MASTER_PUBLIC_KEY_PATH
	| MASTER_TLS_CIPHERSUITES
	| MASTER_ZSTD_COMPRESSION_LEVEL
	| MAX %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| MAX_ROWS
	| MEDIUMBLOB
	| MEDIUMINT
	| MEDIUMTEXT
	...
	| MEMBER /*1N*/
	| MERGE
	| MIN %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| MIN_ROWS
	| MODE
	| MODIFY
	| MULTILINESTRING %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| MULTIPOINT %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| MULTIPOLYGON %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| NAME
	| NAMES
	| NCHAR
	| NESTED
	...
	| PRIVILEGES
	| PROCESS
	| PS_CURRENT_THREAD_ID %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| PS_THREAD_ID %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| PLUGINS
	| POINT %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| POLYGON %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| POSITION %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| PROCEDURE
	| PROCESSLIST
	| PURGE
	| QUERIES
	...
	| REFERENCE
	| REFERENCES
	| REGEXP_INSTR %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| REGEXP_LIKE %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| REGEXP_REPLACE %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| REGEXP_SUBSTR %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| RELAY
	| RELEASE_ALL_LOCKS %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| RELEASE_LOCK %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| REMOVE
	| REORGANIZE
	| REPAIR
	| REPEATABLE
	...
	| ROLLBACK
	| ROW_FORMAT
	| RTRIM %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| S3
	| SECONDARY
	| SECONDARY_ENGINE
	...
	| STATUS
	| STORAGE
	| STD %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| STDDEV %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| STDDEV_POP %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| STDDEV_SAMP %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| STREAM
	| ST_Area %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_AsBinary %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_AsGeoJSON %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_AsText %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_Centroid %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_Dimension %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_EndPoint %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_Envelope %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_ExteriorRing %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_GeoHash %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_GeomFromGeoJSON %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_GeometryCollectionFromText %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_GeometryCollectionFromWKB %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_GeometryFromText %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_GeometryFromWKB %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_GeometryN %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_GeometryType %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_InteriorRingN %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_IsClosed %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_IsEmpty %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_IsSimple %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_LatFromGeoHash %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_Latitude %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_Length %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_LineStringFromText %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_LineStringFromWKB %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_LongFromGeoHash %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_Longitude %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_MultiLineStringFromText %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_MultiLineStringFromWKB %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_MultiPointFromText %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_MultiPointFromWKB %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_MultiPolygonFromText %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_MultiPolygonFromWKB %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_NumGeometries %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_NumInteriorRings %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_NumPoints %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_PointFromGeoHash %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_PointFromText %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_PointFromWKB %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_PointN %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_PolygonFromText %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_PolygonFromWKB %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_StartPoint %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_X %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| ST_Y %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| SUBDATE %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| SUBPARTITION
	| SUBPARTITIONS
	| SUM %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| TABLES
	| TABLESPACE
	| TEMPORARY
	| TEMPTABLE
	...
	| THROTTLE
	| TIES
	| TIME %prec STRING_TYPE_PREFIX_NON_KEYWORD /*3N*/
	| TIMESTAMP %prec STRING_TYPE_PREFIX_NON_KEYWORD /*3N*/
	| TIMESTAMPADD %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| TIMESTAMPDIFF %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| TINYBLOB
	| TINYINT
	| TINYTEXT
	| TRADITIONAL
	...
	| TRIGGER
	| TRIGGERS
	| TRIM %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| TRUNCATE
	| UNBOUNDED
	| UNCOMMITTED
	| UNDEFINED
	...
	| UNTHROTTLE
	| UNUSED
	| UpdateXML %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| UPGRADE
	| USER
	| USER_RESOURCES
	| VALIDATION
	| VAR_POP %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| VAR_SAMP %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| VARBINARY
	| VARCHAR
	| VARIABLES
	| VARIANCE %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| VCPU
	| VEXPLAIN
	| VGTID_EXECUTED
	| VIEW
	...
	| VSCHEMA
	| VTEXPLAIN
	| WAIT_FOR_EXECUTED_GTID_SET %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| WAIT_UNTIL_SQL_THREAD_AFTER_GTIDS %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| WARNINGS
	| WEEK %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	| WITHOUT
	| WORK
	| YEAR
	| ZEROFILL
	...
	| SECOND_MICROSECOND
	| YEAR_MONTH
	| WEIGHT_STRING %prec FUNCTION_CALL_NON_KEYWORD /*2N*/
	;
