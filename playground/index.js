...
const sampleList = [
	...
	["Ansi C parser (partially working)", "cparser.g", "test.c", "ace/mode/c_cpp"],
	["Ansi C c2go parser (partially working)", "cc-c2go.g", "test.c", "ace/mode/c_cpp"],
	["Ansi C ctool parser (partially working)", "ctool-parser.g", "test.c", "ace/mode/c_cpp"],
	...
	["Classp parser", "classp.g", "test.classp", "ace/mode/text"],
	["CleverLang  parser", "clever-parser.g", "test.clever-parser", "ace/mode/c_cpp"],
	["Co2-carbon parser", "co2-carbon.g", "test.co2-carbon", "ace/mode/c_cpp"],
	...
	["C parser (gobject-introspection) (partially working)", "gobject-introspection-scannerparser.g", "test.frama-c", "ace/mode/c_cpp"],
	...
	["OSParseosrl (coin-or/OS) parser", "OSParseosrl.g", "test.OSParseosrl", "ace/mode/xml"],
	["OSParseosrl-no-ws (coin-or/OS) parser", "OSParseosrl.g", "test.OSParseosrl", "ace/mode/xml"],
