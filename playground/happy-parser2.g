...
*/
/******
Notice that this grammar accepts non "literate script" (lines starting with '<').
For "literate script" you'll need to uncomment the following LEX rules
as shown bellow:
^[^>].*	skip()
^">"[ \t]+ skip()
******/
...
//Forn "literate script" grammars uncomment the two rules bellow
//^[^>].*	skip()
//^">"[ \t]+ skip()
