...
nonempty_list_ATTRIBUTE_ :
	ATTRIBUTE
	| nonempty_list_ATTRIBUTE_ ATTRIBUTE
	;

separated_nonempty_list_BAR_production_ :
	production
	| separated_nonempty_list_BAR_production_ BAR production
	;

separated_nonempty_list_BAR_production_group_ :
	production_group
	| separated_nonempty_list_BAR_production_group_ BAR production_group
	;
...
separated_nonempty_list_COMMA_lax_actual_ :
	lax_actual
	| separated_nonempty_list_COMMA_lax_actual_ COMMA lax_actual
	;
...
separated_nonempty_list_COMMA_strict_actual_ :
	strict_actual
	| separated_nonempty_list_COMMA_strict_actual_ COMMA strict_actual
	;

separated_nonempty_list_COMMA_symbol_ :
	symbol
	| separated_nonempty_list_COMMA_symbol_ COMMA symbol
	;

separated_nonempty_list_option_COMMA__nonterminal_ :
	LID
	| separated_nonempty_list_option_COMMA__nonterminal_ option_COMMA_ LID
	;

separated_nonempty_list_option_COMMA__strict_actual_ :
	strict_actual
	| separated_nonempty_list_option_COMMA__strict_actual_ strict_actual option_COMMA_
	;

separated_nonempty_list_option_COMMA__symbol_ :
	symbol
	| separated_nonempty_list_option_COMMA__symbol_ symbol option_COMMA_
	;
...
separated_nonempty_list_option_COMMA__terminal_alias_attrs_ :
	...
	| separated_nonempty_list_option_COMMA__terminal_alias_attrs_ option_COMMA_ UID option_QID_ list_ATTRIBUTE_
	;
