...
%fallback IDENT ALIGNMENT
%fallback IDENT ALLOW_CONNECTIONS
%fallback IDENT ALTER
%fallback IDENT ALWAYS
%fallback IDENT AT /*27L*/
%fallback IDENT ATOMIC
%fallback IDENT ATTACH
%fallback IDENT ATTRIBUTE
%fallback IDENT AUTO
%fallback IDENT AUTOMATIC
%fallback IDENT BACKUP
%fallback IDENT BACKUPS
%fallback IDENT BASETYPE
%fallback IDENT BEFORE
%fallback IDENT BEGIN
%fallback IDENT BINARY
//%fallback IDENT BUCKET_COUNT
%fallback IDENT BUFFER_USAGE_LIMIT
//%fallback IDENT BUNDLE
%fallback IDENT BY
%fallback IDENT BYPASSRLS
%fallback IDENT CACHE
%fallback IDENT CALL
%fallback IDENT CALLED
%fallback IDENT CANCEL
//%fallback IDENT CANCELQUERY
%fallback IDENT CANONICAL
%fallback IDENT CASCADE
%fallback IDENT CASCADED
%fallback IDENT CATEGORY
%fallback IDENT CHAIN
%fallback IDENT CHANGEFEED
%fallback IDENT CHECK_OPTION
%fallback IDENT CLASS
%fallback IDENT CLOSE
%fallback IDENT CLUSTER
%fallback IDENT COLLATABLE
%fallback IDENT COLLATION_VERSION
%fallback IDENT COLUMNS
%fallback IDENT COMBINEFUNC
%fallback IDENT COMMENT
%fallback IDENT COMMENTS
%fallback IDENT COMMIT
%fallback IDENT COMMITTED
%fallback IDENT COMPACT
%fallback IDENT COMPLETE
%fallback IDENT COMPRESSION
%fallback IDENT CONFIGURATION
//%fallback IDENT CONFIGURATIONS
//%fallback IDENT CONFIGURE
%fallback IDENT CONFLICT
%fallback IDENT CONNECTION
%fallback IDENT CONSTRAINTS
//%fallback IDENT CONTROLCHANGEFEED
//%fallback IDENT CONTROLJOB
%fallback IDENT CONVERSION
%fallback IDENT CONVERT
%fallback IDENT COPY
%fallback IDENT COST
%fallback IDENT CREATEDB
//%fallback IDENT CREATELOGIN
%fallback IDENT CREATEROLE
%fallback IDENT CSV
//%fallback IDENT CUBE /*16N*/
%fallback IDENT CURRENT
%fallback IDENT CYCLE
%fallback IDENT DATA
%fallback IDENT DATABASE
%fallback IDENT DATABASES
%fallback IDENT DAY
...
%fallback IDENT DELETE
%fallback IDENT DELIMITER
%fallback IDENT DEPENDS
%fallback IDENT DESERIALFUNC
//%fallback IDENT DESTINATION
%fallback IDENT DETACH
%fallback IDENT DETACHED
%fallback IDENT DICTIONARY
%fallback IDENT DISABLE
%fallback IDENT DISABLE_PAGE_SKIPPING
%fallback IDENT DISCARD
%fallback IDENT DOMAIN
%fallback IDENT DOUBLE
%fallback IDENT DROP
%fallback IDENT EACH
%fallback IDENT ENABLE
%fallback IDENT ENCODING
%fallback IDENT ENCRYPTED
%fallback IDENT ENCRYPTION_PASSPHRASE
%fallback IDENT ENUM
%fallback IDENT ENUMS
%fallback IDENT ESCAPE /*11N*/
%fallback IDENT EVENT
%fallback IDENT EXCLUDE
%fallback IDENT EXCLUDING
%fallback IDENT EXECUTE
//%fallback IDENT EXECUTION
%fallback IDENT EXPERIMENTAL
//%fallback IDENT EXPERIMENTAL_AUDIT
%fallback IDENT EXPERIMENTAL_FINGERPRINTS
%fallback IDENT EXPERIMENTAL_REPLICA
//%fallback IDENT EXPIRATION
%fallback IDENT EXPLAIN
%fallback IDENT EXPORT
%fallback IDENT EXPRESSION
%fallback IDENT EXTENDED
%fallback IDENT EXTENSION
%fallback IDENT EXTERNAL
%fallback IDENT FAMILY
%fallback IDENT FILES
%fallback IDENT FILTER
%fallback IDENT FINALFUNC
%fallback IDENT FINALFUNC_EXTRA
%fallback IDENT FINALFUNC_MODIFY
%fallback IDENT FINALIZE
%fallback IDENT FIRST
%fallback IDENT FOLLOWING /*16N*/
%fallback IDENT FORCE
%fallback IDENT FORCE_INDEX
%fallback IDENT FORMAT
%fallback IDENT FUNCTION
%fallback IDENT FUNCTIONS
%fallback IDENT GENERATED
%fallback IDENT GEOMETRYCOLLECTION
//%fallback IDENT GEOMETRYCOLLECTIONM
//%fallback IDENT GEOMETRYCOLLECTIONZ
//%fallback IDENT GEOMETRYCOLLECTIONZM
//%fallback IDENT GEOMETRYM
//%fallback IDENT GEOMETRYZ
//%fallback IDENT GEOMETRYZM
%fallback IDENT GLOBAL
%fallback IDENT GRANTED
%fallback IDENT GRANTS
%fallback IDENT GROUPS /*16N*/
%fallback IDENT HANDLER
%fallback IDENT HASH
%fallback IDENT HEADER
%fallback IDENT HIGH
%fallback IDENT HISTOGRAM
%fallback IDENT HOUR
%fallback IDENT HYPOTHETICAL
%fallback IDENT ICU_LOCALE
%fallback IDENT ICU_RULES
%fallback IDENT IDENTITY
%fallback IDENT IGNORE_FOREIGN_KEYS
%fallback IDENT IMMEDIATE
%fallback IDENT IMMUTABLE
%fallback IDENT IMPORT
%fallback IDENT INCLUDE
%fallback IDENT INCLUDING
%fallback IDENT INCREMENT
%fallback IDENT INCREMENTAL
%fallback IDENT INDEXES
%fallback IDENT INDEX_CLEANUP
%fallback IDENT INHERIT
%fallback IDENT INHERITS
%fallback IDENT INITCOND
//%fallback IDENT INJECT
%fallback IDENT INLINE
%fallback IDENT INPUT
%fallback IDENT INSERT
%fallback IDENT INSTEAD
//%fallback IDENT INTERLEAVE
%fallback IDENT INTERNALLENGTH
%fallback IDENT INTO_DB
//%fallback IDENT INVERTED
%fallback IDENT INVOKER
%fallback IDENT ISOLATION
%fallback IDENT IS_TEMPLATE
%fallback IDENT JOB
%fallback IDENT JOBS
%fallback IDENT JSON
%fallback IDENT KEY
...
%fallback IDENT LARGE
%fallback IDENT LAST
%fallback IDENT LATEST
%fallback IDENT LC_COLLATE
%fallback IDENT LC_CTYPE
%fallback IDENT LEAKPROOF
//%fallback IDENT LEASE
//%fallback IDENT LESS
%fallback IDENT LEVEL
%fallback IDENT LINESTRING
%fallback IDENT LIST
%fallback IDENT LOCAL
%fallback IDENT LOCALE
%fallback IDENT LOCALE_PROVIDER
%fallback IDENT LOCKED
%fallback IDENT LOGGED
%fallback IDENT LOGIN
%fallback IDENT LOOKUP
%fallback IDENT LOW
%fallback IDENT MAIN
...
%fallback IDENT MFINALFUNC
%fallback IDENT MFINALFUNC_EXTRA
%fallback IDENT MFINALFUNC_MODIFY
%fallback IDENT MINITCOND
%fallback IDENT MINUTE
%fallback IDENT MINVALUE
%fallback IDENT MINVFUNC
//%fallback IDENT MODIFYCLUSTERSETTING
%fallback IDENT MODULUS
%fallback IDENT MONTH
%fallback IDENT MSFUNC
//%fallback IDENT MSPACE
%fallback IDENT MSSPACE
%fallback IDENT MSTYPE
%fallback IDENT MULTILINESTRING
//%fallback IDENT MULTILINESTRINGM
//%fallback IDENT MULTILINESTRINGZ
//%fallback IDENT MULTILINESTRINGZM
%fallback IDENT MULTIPOINT
//%fallback IDENT MULTIPOINTM
//%fallback IDENT MULTIPOINTZ
//%fallback IDENT MULTIPOINTZM
%fallback IDENT MULTIPOLYGON
//%fallback IDENT MULTIPOLYGONM
//%fallback IDENT MULTIPOLYGONZ
//%fallback IDENT MULTIPOLYGONZM
%fallback IDENT MULTIRANGE_TYPE_NAME
%fallback IDENT NAMES
%fallback IDENT NAN
//%fallback IDENT NEVER
%fallback IDENT NEW
%fallback IDENT NEXT
%fallback IDENT NO
%fallback IDENT NOBYPASSRLS
//%fallback IDENT NOCANCELQUERY
//%fallback IDENT NOCONTROLCHANGEFEED
//%fallback IDENT NOCONTROLJOB
%fallback IDENT NOCREATEDB
//%fallback IDENT NOCREATELOGIN
%fallback IDENT NOCREATEROLE
%fallback IDENT NOINHERIT
%fallback IDENT NOLOGIN
//%fallback IDENT NOMODIFYCLUSTERSETTING
%fallback IDENT NOREPLICATION
%fallback IDENT NORMAL
%fallback IDENT NOSUPERUSER
//%fallback IDENT NOVIEWACTIVITY
%fallback IDENT NOWAIT
%fallback IDENT NO_INDEX_JOIN
%fallback IDENT NULLS
%fallback IDENT OBJECT
%fallback IDENT OF
%fallback IDENT OFF
%fallback IDENT OID
%fallback IDENT OIDS
%fallback IDENT OLD
%fallback IDENT ONLY_DATABASE_STATS
%fallback IDENT OPERATOR /*26L*/
%fallback IDENT OPT
%fallback IDENT OPTION
%fallback IDENT OPTIONS
%fallback IDENT ORDINALITY
%fallback IDENT OTHERS
%fallback IDENT OUTPUT
%fallback IDENT OVER
%fallback IDENT OWNED
%fallback IDENT OWNER
%fallback IDENT PARALLEL
%fallback IDENT PARAMETER
%fallback IDENT PARENT
%fallback IDENT PARSER
%fallback IDENT PARTIAL
%fallback IDENT PARTITION /*16N*/
%fallback IDENT PARTITIONS
%fallback IDENT PASSEDBYVALUE
%fallback IDENT PASSWORD
%fallback IDENT PAUSE
%fallback IDENT PAUSED
%fallback IDENT PHYSICAL
%fallback IDENT PLAIN
%fallback IDENT PLAN
%fallback IDENT PLANS
//%fallback IDENT POINTM
//%fallback IDENT POINTZ
//%fallback IDENT POINTZM
%fallback IDENT POLICY
//%fallback IDENT POLYGONM
//%fallback IDENT POLYGONZ
//%fallback IDENT POLYGONZM
%fallback IDENT PRECEDING /*16N*/
%fallback IDENT PREFERRED
%fallback IDENT PREPARE
%fallback IDENT PRESERVE
%fallback IDENT PRIORITY
%fallback IDENT PRIVILEGES
%fallback IDENT PROCEDURAL
%fallback IDENT PROCEDURE
%fallback IDENT PROCEDURES
%fallback IDENT PROCESS_MAIN
%fallback IDENT PROCESS_TOAST
%fallback IDENT PUBLIC
%fallback IDENT PUBLICATION
%fallback IDENT QUERIES
%fallback IDENT QUERY
%fallback IDENT RANGE /*16N*/
%fallback IDENT RANGES
%fallback IDENT READ
%fallback IDENT READ_ONLY
%fallback IDENT READ_WRITE
%fallback IDENT RECEIVE
%fallback IDENT RECURRING
...
%fallback IDENT REMAINDER
%fallback IDENT RENAME
%fallback IDENT REPEATABLE
%fallback IDENT REPLACE
%fallback IDENT REPLICA
%fallback IDENT REPLICATION
%fallback IDENT RESET
%fallback IDENT RESTART
%fallback IDENT RESTORE
%fallback IDENT RESTRICT
%fallback IDENT RESTRICTED
%fallback IDENT RESUME
//%fallback IDENT RETRY
%fallback IDENT RETURN
%fallback IDENT RETURNS
%fallback IDENT REVISION_HISTORY
%fallback IDENT REVOKE
%fallback IDENT ROLE
%fallback IDENT ROLES
%fallback IDENT ROLLBACK
//%fallback IDENT ROLLUP /*16N*/
%fallback IDENT ROUTINE
%fallback IDENT ROUTINES
%fallback IDENT ROWS /*16N*/
%fallback IDENT RULE
%fallback IDENT RUNNING
%fallback IDENT SAFE
%fallback IDENT SAVEPOINT
//%fallback IDENT SCATTER
%fallback IDENT SCHEDULE
%fallback IDENT SCHEDULES
%fallback IDENT SCHEMA
%fallback IDENT SCHEMAS
%fallback IDENT SCRUB
%fallback IDENT SEARCH
%fallback IDENT SECOND
%fallback IDENT SECURITY
%fallback IDENT SECURITY_BARRIER
%fallback IDENT SECURITY_INVOKER
%fallback IDENT SEED
%fallback IDENT SEND
%fallback IDENT SEQUENCE
%fallback IDENT SEQUENCES
%fallback IDENT SERIALFUNC
%fallback IDENT SERIALIZABLE
%fallback IDENT SERVER
%fallback IDENT SESSION
%fallback IDENT SESSIONS
%fallback IDENT SET /*2N*/
//%fallback IDENT SETTING
//%fallback IDENT SETTINGS
%fallback IDENT SFUNC
%fallback IDENT SHARE
%fallback IDENT SHAREABLE
%fallback IDENT SHOW
%fallback IDENT SIMPLE
%fallback IDENT SKIP
%fallback IDENT SKIP_DATABASE_STATS
%fallback IDENT SKIP_LOCKED
%fallback IDENT SKIP_MISSING_FOREIGN_KEYS
%fallback IDENT SKIP_MISSING_SEQUENCES
%fallback IDENT SKIP_MISSING_SEQUENCE_OWNERS
%fallback IDENT SKIP_MISSING_VIEWS
%fallback IDENT SNAPSHOT
%fallback IDENT SORTOP
//%fallback IDENT SPLIT
//%fallback IDENT SQL
%fallback IDENT SSPACE
%fallback IDENT STABLE
%fallback IDENT START
%fallback IDENT STATEMENT
%fallback IDENT STATISTICS
%fallback IDENT STATUS
%fallback IDENT STDIN
%fallback IDENT STORAGE
//%fallback IDENT STORE
%fallback IDENT STORED
%fallback IDENT STRATEGY
%fallback IDENT STRICT
%fallback IDENT STYPE
%fallback IDENT SUBSCRIPT
%fallback IDENT SUBSCRIPTION
%fallback IDENT SUBTYPE
%fallback IDENT SUBTYPE_DIFF
%fallback IDENT SUBTYPE_OPCLASS
%fallback IDENT SUPERUSER
%fallback IDENT SUPPORT
%fallback IDENT SYNTAX
%fallback IDENT SYSID
%fallback IDENT SYSTEM
...
%fallback IDENT TEXT
%fallback IDENT THROTTLING
%fallback IDENT TIES
%fallback IDENT TRACE
%fallback IDENT TRANSACTION
%fallback IDENT TRANSACTIONS
%fallback IDENT TRANSFORM
%fallback IDENT TRIGGER
%fallback IDENT TRUNCATE
%fallback IDENT TRUSTED
%fallback IDENT TYPE
%fallback IDENT TYPES
%fallback IDENT TYPMOD_IN
%fallback IDENT TYPMOD_OUT
%fallback IDENT UNBOUNDED /*15N*/
%fallback IDENT UNCOMMITTED
%fallback IDENT UNKNOWN
%fallback IDENT UNLOGGED
%fallback IDENT UNSAFE
//%fallback IDENT UNSPLIT
%fallback IDENT UNTIL
%fallback IDENT UPDATE
%fallback IDENT UPSERT
//%fallback IDENT USAGE
%fallback IDENT USE
%fallback IDENT USERS
%fallback IDENT VACUUM
%fallback IDENT VALID
%fallback IDENT VALIDATE
%fallback IDENT VALIDATOR
%fallback IDENT VALUE
%fallback IDENT VARIABLE
%fallback IDENT VARYING
%fallback IDENT VERSION
%fallback IDENT VIEW
//%fallback IDENT VIEWACTIVITY
%fallback IDENT WITHIN
%fallback IDENT WITHOUT
...
%nonassoc /*16*/ IDENT FOLLOWING GROUPS NULL PARTITION PRECEDING RANGE ROWS //CUBE ROLLUP
