...
"record"	RECORD_TOKEN
"rem"	REM_TOKEN
"renames"	RENAMES_TOKEN
"return"	RETURN_TOKEN
"reverse"	REVERSE_TOKEN
"select"	SELECT_TOKEN
"separate"	SEPARATE_TOKEN
...
[a-zA-Z]([_]?[a-zA-Z0-9])*	IDENTIFIER
([0-9]+\.[0-9]*|\.[0-9]+)([Ee](\+|\-)?[0-9]+)?	REAL_LITERAL
[0-9]+	INTEGER_LITERAL
'(\\.|[^'\n\r\\])'	CHARACTER_LITERAL
\"(\\.|[^\"\n\r\\])*\"	STRING_LITERAL
