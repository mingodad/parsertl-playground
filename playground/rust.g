...
0x[0-9a-fA-F_]+|0o[0-7_]+|0b[01_]+|[0-9][0-9_]*|[0-9][0-9_]*\.(\.|[a-zA-Z])	LIT_INTEGER
b'([^'\n\r]|\\[^\n\r])'	LIT_BYTE
'(\\.|[^'\n\r\\])+'	LIT_CHAR
[0-9][0-9_]*\.[0-9_]*([eE][-\+]?[0-9_]+)?|[0-9][0-9_]*(\.[0-9_]*)?[eE][-\+]?[0-9_]+	LIT_FLOAT
\"([^\"\n]|\\[^\n])*\"	LIT_STR
